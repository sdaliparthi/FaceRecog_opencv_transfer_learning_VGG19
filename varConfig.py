...
modelNameToSave    = 'faceRecogModel_vgg19.h5' # Name to be used while saving the model

# recogFace variables
collectFacesDatSetUsingCam = True # Whether or not to collect the training and testing dataset
learnFacesUsingVGG19       = True # Whether or not to learn and build the model based on testing and training data
